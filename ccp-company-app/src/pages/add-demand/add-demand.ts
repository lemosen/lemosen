...
/**
 * Generated class for the AddDemandPage page.
 *
...
export class AddDemandPage extends FormPage {
    ...
    ngOnInit(): void {
        ...
        this.demandServiceProvider.listDemandCategories().then(data => {
            if (data != null && data.length != 0) {
                ...
                this.selectCategory = this.demandCategories[0];
                this.formGroup.patchValue({
        ...
        let alert = this.alertCtrl.create({
            ...
            buttons: [{
                ...
                handler: data => {
                    ...
                    skillLevels.forEach(skillLevel => skillLevel.check = false);
    ...
    onSubmit(state: boolean) {
        ...
        if (this.formGroup.valid) {
            ...
            this.demandServiceProvider.createDemand(demand).then(data => {
                    if (data == 'success') {
                        this.navCtrl.pop();
